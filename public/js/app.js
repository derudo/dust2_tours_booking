document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderSchedule(tours) {
    ...
    tours.forEach(tour => {
      ...
      const tourImageHtml = tour.image 
        ? `<img src="${tour.image}" alt="${tour.title}" onerror="this.style.opacity='0'; this.style.pointerEvents='none';">`
        : '';
      ...
      card.innerHTML = `
        <div class="tour-postcard-image-wrapper">
          ...
          <div class="postcard-image-inner">
            ...
            ${tourImageHtml}
            <div class="postcard-stamp-flair" style="z-index: 3;">PASSPORTS APPROVED</div>
          </div>
        </div>
